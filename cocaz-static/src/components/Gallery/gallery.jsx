...
import { Camera, Video as VideoIcon, X, Play, ImageIcon, Expand } from 'lucide-react';
    ...
    >
      <defs>
        <linearGradient id="logoGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" style={{stopColor: '#5fd75f', stopOpacity:1}} />
        </linearGradient>
      </defs>
      <path 
...
const Gallery = () => {
  ...
  const mediaItems = [
    ...
    { type: 'video', src: '../assets/cocazvid.mp4', alt: 'COCAZ Event 2', caption: 'Behind the Scenes: Bootcamp' },
  ...
  return (
    <motion.div
      ...
      className={`container mx-auto px-4 py-8 ${currentTheme.text} relative`}
    >
      <motion.h1 
      ...
      <motion.p 
        ...
        animate={{ opacity: 0.8 }}
      >
        Explore the vibrant world of COCAZ through our event gallery. From award ceremonies to behind-the-scenes footage, witness the energy and creativity that define our community.
      </motion.p>
                ...
                <div className="text-center p-4">
                  ...
                  <div className="flex justify-center space-x-4">
                    <motion.button
                      ...
                      onClick={() => setSelectedMedia(item)}
                    >
                      {item.type === 'video' ? <VideoIcon size={18} /> : <ImageIcon size={18} />}
                      <span>View</span>
                    </motion.button>
                    <motion.button
          ...
          >
            ...
            >
              ...
              >
                ...
                <p className={`mt-4 text-center ${currentTheme.text} font-medium`}>
